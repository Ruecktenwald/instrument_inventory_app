...
def brass_metrics(request: HttpRequest) -> HttpResponse:
    ...
    brass_instruments_oil = [
        "trumpet_oil_accessory_only",
        "trombone_oil_accessory_only",
        "french_horn_oil_accessory_only",
        "baritone_horn_oil_accessory_only",
    ]

    instruments_brass = ["trumpet", "trombone", "french horn", "baritone horn"]
    instrument_counts = {
        instrument: instruments.filter(instrument_kind=instrument)
    ...
    trumpet_oil_accessory_only = instruments.filter(
        instrument_kind="trumpet", oil_accessory=True
    ).count()
    trombone_oil_accessory_only = instruments.filter(
        instrument_kind="trombone", oil_accessory=True
    ).count()
    french_horn_oil_accessory_only = instruments.filter(
        instrument_kind="french horn", oil_accessory=True
    ).count()
    baritone_horn_oil_accessory_only = instruments.filter(
        instrument_kind="baritone horn", oil_accessory=True
    ).count()

    trumpet_mouth_piece_accessory_only = instruments.filter(
        instrument_kind="trumpet", mouth_piece_accessory=True
    ).count()
    trombone_mouth_piece_accessory_only = instruments.filter(
        instrument_kind="trombone", mouth_piece_accessory=True
    ).count()
    french_horn_mouth_piece_accessory_only = instruments.filter(
        instrument_kind="french horn", mouth_piece_accessory=True
    ).count()
    baritone_horn_mouth_piece_accessory_only = instruments.filter(
        instrument_kind="baritone horn", mouth_piece_accessory=True
    ).count()

    trumpet_polishing_cloth_accessory_only = instruments.filter(
        instrument_kind="trumpet", polishing_cloth_accessory=True
    ).count()
    trombone_polishing_cloth_accessory_only = instruments.filter(
        instrument_kind="trombone", polishing_cloth_accessory=True
    ).count()
    french_horn_polishing_cloth_accessory_only = instruments.filter(
        instrument_kind="french horn", polishing_cloth_accessory=True
    ).count()
    baritone_horn_polishing_cloth_accessory_only = instruments.filter(
        instrument_kind="baritone horn", polishing_cloth_accessory=True
    ).count()

    total_brass = trumpet_only + trombone_only + french_horn_only + baritone_horn_only
    total_polishing_cloths = (
        trumpet_polishing_cloth_accessory_only
        + trombone_polishing_cloth_accessory_only
        + french_horn_polishing_cloth_accessory_only
        + baritone_horn_polishing_cloth_accessory_only
    )
    total_oil = (
        trumpet_oil_accessory_only
        + trombone_oil_accessory_only
    ...
    trumpet_books_only = Instrument.objects.filter(
        instrument_kind="trumpet", book_accessory=True
    ).count()
    french_horn_sax_books_only = Instrument.objects.filter(
        instrument_kind="french horn", book_accessory=True
    ).count()
    trombone_books_only = Instrument.objects.filter(
        instrument_kind="trombone", book_accessory=True
    ).count()
    baritone_horn_books_only = Instrument.objects.filter(
        instrument_kind="baritone horn", book_accessory=True
    ).count()
    ...
    return render(
        ...
        "brass_metrics.html",
        {
            ...
            "brass_count": brass_count,
            "brass_instruments_oil": brass_instruments_oil,
            "brass_instruments_kind": brass_instruments_kind,
            "missing_oil_or_cloth": missing_oil_or_cloth,
            "french_horn_only": french_horn_only,
            "baritone_horn_only": baritone_horn_only,
            "trumpet_only": trumpet_only,
            "trombone_only": trombone_only,
            "baritone_horn_mouth_piece_accessory_only": baritone_horn_mouth_piece_accessory_only,
            ...
            "trumpet_books_only": trumpet_books_only,
            "trombone_books_only": trombone_books_only,
            "baritone_horn_books_only": baritone_horn_books_only,
            "trumpet_oil_accessory_only": trumpet_oil_accessory_only,
            "trombone_oil_accessory_only": trombone_oil_accessory_only,
            "french_horn_oil_accessory_only": french_horn_oil_accessory_only,
            "baritone_horn_oil_accessory_only": baritone_horn_oil_accessory_only,
            ...
            "total_brass": total_brass,
            "total_polishing_cloths": total_polishing_cloths,
            "total_oil": total_oil,
        },
    )
